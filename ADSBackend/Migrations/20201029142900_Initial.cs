        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(nullable: true),
                    profileImageSource = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessage_Member_AuthorId",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatSessionMember", x => new { x.ChatSessionId, x.MemberId });
                    table.ForeignKey(
                        name: "FK_ChatSessionMember_ChatSession_ChatSessionId",
                        column: x => x.ChatSessionId,
                        principalTable: "ChatSession",
                        principalColumn: "ChatSessionId");
                    table.ForeignKey(
                        name: "FK_ChatSessionMember_Member_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Member",
                        principalColumn: "MemberId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberFriend", x => new { x.MemberId, x.FriendId });
                    table.ForeignKey(
                        name: "FK_MemberFriend_Member_FriendId",
                        column: x => x.FriendId,
                        principalTable: "Member",
                        principalColumn: "MemberId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberFriend_Member_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Member",
                        principalColumn: "MemberId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Body = table.Column<string>(nullable: true),
                    Image = table.Column<string>(nullable: true),
                    IsMachinePost = table.Column<bool>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    EditedAt = table.Column<DateTime>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reaction_Member_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Member",
                        principalColumn: "MemberId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WallPost", x => new { x.WallId, x.PostId });
                    table.ForeignKey(
                        name: "FK_WallPost_Post_PostId",
                        column: x => x.PostId,
                        principalTable: "Post",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WallPost_Wall_WallId",
                        column: x => x.WallId,
                        principalTable: "Wall",
                        principalColumn: "WallId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatSessionMember_MemberId",
                table: "ChatSessionMember",
                column: "MemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reaction_MemberId",
                table: "Reaction",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_WallPost_PostId",
                table: "WallPost",
                column: "PostId");
        }
